    ...
    return (
        <View
            ...
            <TouchableOpacity onPress={sharePress} style={{padding: 10}}>
                <Image
                    source={require('../assets/icon/ic_share.png')}
                    style={{
                        height: 18,
                        width: 18,
                        tintColor: 'white',
            ...
            <TouchableOpacity onPress={editPress} style={{padding: 10}}>
                <Image
                    source={require('../assets/icon/ic_edit.png')}
                    style={{height: 18, width: 18, resizeMode: 'contain'}}
                />
            </TouchableOpacity>
            <TouchableOpacity onPress={deletePress} style={{padding: 10}}>
                <Image
