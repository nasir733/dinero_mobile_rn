...
const dataArr = [
    {
        heading: 'Office Standard Program',
        bullets: [
            'Unlimited calls within the US/CA**',
            'Team messaging and collaboration',
            'Unlimited audio meetings',
            'Unlimited video conferencing (up to 4 peopleper meeting)',
                        ...
                        <Surface
                            ...
                            <TouchableOpacity
                                ...
                                <Text
                                    ...
                                    Click Here To Get Toll Free Number
                                </Text>
                            </TouchableOpacity>
                        </Surface>
                    </View>
