...
const dataArr = [
    {
        link: 'https://www.youtube.com/channel/UC32ZuoC9yrGlrJT6ez5MJjA',
        heading:
            'Watch The Video On How To Get Established With Business Equifax',
        youtubeUrl: 'ftWyCCwYSPU',
    },
];

const {width, height} = Dimensions.get('window');

function EquifixBussiness() {
                    ...
                    <View
                        ...
                        <Surface
                            ...
                            <TouchableOpacity
                                onPress={() => {
                                    Linking.openURL(
                                        'http://app.nav.com/registration-f/i-o-bi?clickid=1w4wBvW15xyJTEhwUx0Mo3EzUki1Kh1Vqx9Jwk0&iradid=675356&irpid=2006174&iradtype=TEXT_LINK&iradsize=&irmpname=Zephaniah%20Langley&irmptype=mediapartner&sharedid=&utm_source=Affiliate&utm_campaign=2006174&utm_medium=Zephaniah%20Langley&plan=business-boost',
                                    );
                                }}
                                style={{
                                    marginTop: 5,
                                ...
                                <Text
                                    ...
                                    Check My Business Equifax Report
                                </Text>
                            </TouchableOpacity>
                        </Surface>
                    </View>
